package com.ysw.aipassagecreator.model.enums;
 ...
 * 否- isAiGenerated: 是为 AI 生图方式（决定使用 prompt 还是 keywords）
 * - isFallback: 是否为降级方案
 *
...
public enum ImageMethodEnum {
    ...
    ImageMethodEnum(String value, String description, boolean aiGenerated, boolean fallback) {
        ...
        this.aiGenerated = aiGenerated;//ai人工智能生成
        this.fallback = fallback;//后备
    }
