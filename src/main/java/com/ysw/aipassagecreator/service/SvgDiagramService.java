...
import com.ysw.aipassagecreator.config.SvgDiagramConfig;
import com.ysw.aipassagecreator.config.SvgDiagramConfig;
...
import static com.ysw.aipassagecreator.constant.ArticleConstant.PICSUM_URL_TEMPLATE;
/**
 * 接收前端绘图需求、文字描述
 * 调用通义千问大模型，智能生成标准 SVG 代码
 * 校验格式后转为图片字节流，当成图片返回
 * 多用于生成思维导图、关系图、概念结构图、简易插画
 */
